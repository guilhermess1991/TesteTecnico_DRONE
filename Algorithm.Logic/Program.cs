...
namespace Algorithm.Logic
{
    ...
    using Algorithm.Logic.Domain.Command.Handlers;
    ...
    public class Program
    {
        ...
        public static string Evaluate(string input)
        {
            ...
            var handler = new DroneCommandHandler();
            var result = (DroneResult)handler.Handler(new DroneCommand { Instruction = input });
            return result.Drone.ToString();
        }
    }
}
